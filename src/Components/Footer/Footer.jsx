    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
              <a href="" className="flex font-semibold   gap-2 text-2xl sm:text-3xl">
                <img class="w-auto h-9" src={footer} alt="" />
                Foodie
                </a>
                <p class="text-base leading-relaxed text-gray-600 mt-7">© 2025 Your Website Name. All rights reserved.</p>
            ...
            <div class="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                ...
                <form action="#" method="POST" class="mt-6">
                    ...
                    <button type="submit" class="inline-flex items-center justify-center bg-yellow-400 text-white px-4 py-2 my-4 font-semibold rounded">Subscribe</button>
                </form>
            </div>
        </div>
        ...
        <p class="text-sm text-center text-gray-600">© Copyright 2025, All Rights Reserved by Foodie</p>
    </div>
</section>
